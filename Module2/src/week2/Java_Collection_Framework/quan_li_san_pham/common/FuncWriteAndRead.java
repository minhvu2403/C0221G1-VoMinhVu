package week2.Java_Collection_Framework.quan_li_san_pham.common;
...
public class FuncWriteAndRead {
    static final String PATH_PRODUCT = "src/week2/Java_Collection_Framework/quan_li_san_pham/data/Product.csv";
