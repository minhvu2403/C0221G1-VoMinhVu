    ...
    <div class="table-wrapper">
        <div class="table-title">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <a href="customer?action=add" class="btn btn-success"><i class="material-icons">&#xE147;</i>
                    ...
                    <a href="#deleteServiceModal" id="btn" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xe92b;</i>
                        <span>Delete</span></a>
                    <button  class="sort" type="submit"><a href="customer?action=sort"><i class="fa fa-sort"> Sort</i></a></button>
                </div>
            </div>
        </div>
        <table class="table table-striped table-hover" id="showList">
            <thead>
            <tr>
                <th>
            ...
            <c:forEach items='${customer}' var="customer">
                <tr>
                    <td>
                    <span class="custom-checkbox">
                        <input type="checkbox" id="${customer.id}" name="checkbox"value="${customer.id}">
                    ...
                    <td>
                        ...
                        <a href="#deleteServiceModal" onclick="setIdDelete(${customer.id})" class="delete"
