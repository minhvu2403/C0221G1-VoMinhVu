package com.example.codegym.aop;
...
public class LibraryAop {
    ...
    @Pointcut("execution(* com.example.codegym.controller.PersonalCodeController.borrowBook(..))")
    ...
    @Pointcut("execution(* com.example.codegym.controller.PersonalCodeController.returnBook(..))")
    ...
    @Pointcut("execution(* com.example.codegym.controller.PersonalCodeController.*(..))")
