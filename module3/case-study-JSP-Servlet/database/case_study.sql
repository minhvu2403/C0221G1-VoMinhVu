...
INSERT INTO `case_study_jsp_and_servlet`.`customer` (`customer_id`, `customer_name`, `customer_birthday`, `customer_gender`, `customer_id_card`, `customer_phone`, `customer_email`, `customer_address`, `customer_type_id`) VALUES ('3', 'Jang', '1999-11-25', b'1', '044200002961', '0944524135', 'teopro1234@gmail.com', 'Quảng Trị', '3');
INSERT INTO `case_study_jsp_and_servlet`.`customer` (`customer_id`, `customer_name`, `customer_birthday`, `customer_gender`, `customer_id_card`, `customer_phone`, `customer_email`, `customer_address`, `customer_type_id`) VALUES ('4', 'Long', '1991-05-09', b'1', '044200002961', '0944524135', 'teopro1234@gmail.com', 'Huế', '4');
INSERT INTO `case_study_jsp_and_servlet`.`customer` (`customer_id`, `customer_name`, `customer_birthday`, `customer_gender`, `customer_id_card`, `customer_phone`, `customer_email`, `customer_address`, `customer_type_id`) VALUES ('5', 'Dũng', '1997-09-09', b'0', '044200002961', '0944524135', 'teopro1234@gmail.com', 'Gia Lai', '5');
...
('Phục vụ'),
('Quản Lý');
INSERT INTO employee(employee_name,employee_birthday,employee_id_card,employee_phone,employee_salary,employee_email,employee_address)
VALUEs('Nguyen Thi Hoa',1,1,3,'1990-12-12',201535456,300,0905222321,'A@gmail.com','Đà Nẵng'),
...
select
 ...
 SELECT employee_id,employee_name,employee_birthday,employee_id_card,employee_phone,employee_salary,employee_email,employee_address,position_name,education_degree_name,division_name,username FROM
 employee LEFT JOIN 
...
SELECT * FROM case_study_jsp_and_servlet.employee WHERE id =1;